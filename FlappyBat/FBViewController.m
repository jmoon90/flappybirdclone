...
- (void)viewDidLoad
{
    ...
    [background setImage:[UIImage imageNamed:@"han.png"]];
    ...
    [bird setAnimationImages:@[[UIImage imageNamed:@"john.png"]]];
...
#define FBHoleHeight 200 // The hole given for the bird to fly through. Larger the bigger the room
...
- (void)addNewBar:(NSTimer *)timer {
    ...
    [newBottomBar setImage:[[UIImage imageNamed:@"pipe.png"] resizableImageWithCapInsets:UIEdgeInsetsMake(0, 0, 20, 0)]];
